...
public class UserPage extends javax.swing.JFrame {
    ...
    private void btn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn1MouseClicked
        ...
        p.setVisible(true);
            ...
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id FROM inventory where product_name='Samsung Galaxy'";
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    p.setC1(String.valueOf(categoryId));
                    p.setC2(categoryName);
                    p.setP1(String.valueOf(productId));
                }
...
public void btn2click() {
    ...
    if (conn != null) {
        String query = "INSERT INTO sellProducts (category_id, category_name, product_id, product_name, price, quantity, total_price)"
                + " VALUES (?, ?, ?, ?, ?, ?, ?)";
        try (PreparedStatement pstmt = conn.prepareStatement(query)) {
            pstmt.setInt(1, p.getC1());
            pstmt.setString(2, p.getC2());
            pstmt.setInt(3, p.getP1());
            pstmt.setString(4, p.getVarName());
            pstmt.setInt(5, p.getPrice());
            pstmt.setInt(6, p.getPr2());
            pstmt.setInt(7, p.getPr3());
    ...
    private void btn2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn2MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='Perfume'";
            ...
            try (PreparedStatement pstmt = conn.prepareStatement(query);
                ...
                while (resultSet.next()) {
                    ...
                    p.setC2(categoryName);
                    p.setP1(String.valueOf(productId));
                    p.setVarName(ProductName);
                    p.setPrice(String.valueOf(Price2));
    ...
    private void btn3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn3MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='Mushroom'";
    ...
    private void btn4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn4MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='Grapes'";
    ...
    private void btn5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn5MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='JBL Headphone'";
    ...
    private void btn6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn6MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='iPhone 15'";
    ...
    private void btn7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn7MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where category_name = 'Fashion'";
    ...
    private void btn8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn8MouseClicked
        ...
        p.setVisible(true);
            ...
            Connection conn = mysqlconnection.openConnection();
            if (conn != null) {
            String query = "SELECT category_id,category_name,product_id, price ,product_name FROM inventory where product_name='Chocolate Bar'";
